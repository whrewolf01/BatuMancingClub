...
$sql = "SELECT id_pengguna, username, password,email  FROM tb_login";
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="dashboard-info.php">Info</a></li>
        ...
        <table>
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    echo "<tr><td>" . $row["id_pengguna"] . "</td><td>" . $row["username"] . "</td><td>" . $row["email"] . "</td></tr>";
                }
            } else {
